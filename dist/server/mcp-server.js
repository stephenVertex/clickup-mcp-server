...
export class ClickUpMCPServer {
    ...
    setupRoutes() {
        ...
        const authorizeHandler = (req, res) => {
            ...
            const { url, state: authState } = this.oauth2Service.createAuthorizationUrl(`${config.baseUrl}${config.oauth.callbackPath}`, state);
            ...
            this.sessions.set(authState, {
                ...session,
                workspaceId: redirect_uri // temporarily store redirect_uri
            });
        ...
        const tokenHandler = async (req, res) => {
            ...
            try {
                ...
                if (grant_type === 'authorization_code') {
                    ...
                    tokenData = await this.oauth2Service.exchangeCodeForToken(code, foundState || 'unknown');
